...
#aponta para os arquivos gerados pelo docker
#onde estaram os arquivos de static e media
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #witenoise to deploy on railway
...
SUMMERNOTE_CONFIG = {
 ...
 #witenoise to deploy on railway
